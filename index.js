...
module.exports = function footnote_plugin(md) {
  ...
  // md.inline.ruler.after('image', 'anchor_inline', anchor_inline);
  // md.inline.ruler.after('anchor_inline', 'anchor_ref', anchor_ref);
  // md.core.ruler.after('inline', 'anchor_tail', anchor_tail);
};
